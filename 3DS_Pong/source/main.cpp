...
int main()
{
	...
	while (aptMainLoop()) {
		...
		newTime = time(NULL);
		deltaTime = difftime(currentTime, newTime);
		currentTime = newTime;
		...
		sf2d_start_frame(GFX_TOP, GFX_LEFT);
			sf2d_draw_fill_circle(offset3d + ball.getX(), ball.getY(), 20, RGBA8(0x00, 0xFF, 0x00, 0xFF));
		...
		sf2d_start_frame(GFX_TOP, GFX_RIGHT);
			...
			sf2d_draw_fill_circle(ball.getX(), ball.getY(), 20, RGBA8(0x00, 0xFF, 0x00, 0xFF));
